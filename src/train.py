...
parser.add_argument('--use_masks', default=False, action="store_true", help='use_masks')
...
x_train, y_train = api.load_images_masks(os.path.join(args.data_dir, "train"), use_masks=args.use_masks, image_size=args.image_size)
print(x_train.shape)
print(y_train.shape)
x_test, y_test = api.load_images_masks(os.path.join(args.data_dir, "val"), use_masks=args.use_masks, image_size=args.image_size)
print(x_test.shape)
print(y_test.shape)
